#!/usr/bin/env python3
"""
PhantomGuard Agent Runner
Wraps and executes agents with PhantomGuard monitoring
"""
...
class AgentRunner:
    ...
    def _create_phantomguard_hook(self) -> PhantomGuardHook:
        """Create PhantomGuard monitoring hook"""
        task = TaskDefinition(
    ...
    def run(self, user_prompt: Optional[str] = None) -> Dict[str, Any]:
        """
        Run agent with PhantomGuard monitoring
        
        Returns:
            Dict with execution results and monitoring report
        """
        print("="*60)
        print(f"🛡️  PhantomGuard Agent Runner")
        print("="*60)
        ...
        try:
            ...
            guard = self._create_phantomguard_hook()
            print("✅ PhantomGuard monitoring enabled")
