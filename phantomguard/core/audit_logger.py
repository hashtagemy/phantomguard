# phantomguard/core/audit_logger.py
"""
Structured audit logging for PhantomGuard quality monitoring.
...
logger = logging.getLogger("phantomguard.audit")
...
class LocalFileStore:
    ...
    def __init__(self, base_dir: str | None = None):
        import os
        self.base = Path(base_dir or os.environ.get("PHANTOMGUARD_LOG_DIR", "phantomguard_logs"))
